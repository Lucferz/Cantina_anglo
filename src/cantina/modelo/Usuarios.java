...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Usuarios.findAll", query = "SELECT u FROM Usuarios u WHERE u.idusuario = 1")
    , @NamedQuery(name = "Usuarios.findAllEstadoTrue", query = "SELECT u FROM Usuarios u")
